...
o1Switch: суть в том что вместо switch(a) используется таблица функций с одинаковым типом возврата и аргументом - может быть любым это для общего пользования
